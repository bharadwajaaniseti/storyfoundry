...
export default function ChapterComments({ chapterId, className = '' }: ChapterCommentsProps) {
  ...
  const loadReviews = async () => {
    // For now, we'll simulate reviews using comments with a special type
    // In a full implementation, you'd want a separate reviews table
    try {
  ...
  const submitReview = async () => {
    ...
    try {
      setIsSubmitting(true)
      // For now, we'll add to local state. In production, you'd call an API
