...
export default function ReaderProfilePage() {
  ...
  const loadProfileData = async () => {
    try {
      ...
      // Mock reading activity data (replace with real data later)
      const mockReadingActivity: ReadingActivity[] = [
        {
          id: '1',
          project_title: 'The Chronicles of Eldoria',
        ...
        },
        {
          ...
          last_read: new Date(Date.now() - 86400000).toISOString(),
      ...
      const enhancedProfile = {
        ...
        projects_read: mockReadingActivity.filter(a => a.completion_percentage === 100).length,
        total_reading_time: mockReadingActivity.length * 5 // Mock hours
      }

      setProfile(enhancedProfile)
      setReadingActivity(mockReadingActivity)
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {[
            ...
            { label: 'Reading Hours', value: profile.total_reading_time, icon: Library, gradient: 'from-orange-400 to-orange-500' },
          ].map((stat, index) => (
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-xs font-medium text-gray-500 bg-gray-50 px-2 py-1 rounded-full">
                    {stat.label === 'Followers' ? '+8%' :
                     ...
                     stat.label === 'Books Read' ? 'Completed' : 'This month'}
                  </div>
                </div>
