-- Add helper function for setting session variables
...
-- Function to update content without triggering versioning (for approvals)
...
-- Update the auto-versioning trigger to respect skip flag during approvals
